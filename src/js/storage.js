// addFav.push(["639b6de9ff77d221f190c62d","639b6de9ff77d221f190c560","639b6de9ff77d221f190c509"])
...
// const saveBtn = document.querySelector('button[data-action="639b6de9ff77d221f190c62d"]');
...
// let dataSet = newSaveButton.dataset.action;
// let dataSet = '';
...
const searchDivEvent = document.querySelector('.father-div')
const gallery = document.querySelector('.gallery')
// console.log(searchDivEvent);

gallery.addEventListener('click', event => {
    if ( //* onClick add fav
        event.target.nodeName === 'BUTTON' &&
        // event.target.className === 'saveButton' ||
...
function markup({ glass, category, ingredients }) {
    ...
    const markup = `<div class="cocktail-card-main" id="cocktail-card-item">
        <img class="cocktail-card-img" src="#" alt="${category}" width="" height="" />
        <h3 class="card-cocktail-name">${ingredients[0].measure}</h3>
        <p class="card-cocktail-desc">${ingredients[0].title}</p>
        <div class="buttons-container">
        <button type="button" class="learn-more-btn" data-id="${category}">learn more</button>
