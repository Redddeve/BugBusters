...
function cocktailFavCardTemplate(
  ...
  const markup = `<li class="cocktail-card-main" id="cocktail-card-item">
        ...
        <button type="button" class="delete-btn card-cocktail-delete-icon-use" aria-label="Remove from favorites">
...
function cocktailMainCardTemplate(
  ...
  const markup = `<li class="cocktail-card-main" id="cocktail-card-item">
          ...
          <p class="card-cocktail-desc">${cocktailDesc}</p>
          <div class="buttons-container">
            <button type="button" class="learn-more-btn" aria-label="Learn More" data-id=${cocktailID}>
              learn more
            </button>
            <button
              type="button"
